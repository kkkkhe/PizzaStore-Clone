...
import './header.scss'
export const Header = () => {
	const {totalSum, totalCount} = useAppSelector(state => state.setCart)
	...
	return (
		<div className="header-body body-header">
			<div onClick={() => navigate(-1)} className="body-header__info">
					<img className="body-header__logo" src='imgs/pizzaLogo.jpg'></img>	
				<div className="body-header__box">
					<div className="body-header__title">REACT PIZZA</div>
					<div className="body-header__paragraph">самая вкусная пицца во вселенной</div>
				</div>
			</div>
			<div className="body-header__wrapper">
				<NavLink to={'cart'} className="body-header__cash">
					{totalSum}
					<div style={{marginLeft: 4}}>₴</div>
				<div className="body-header__cart">{totalCount}
